    ...
    return (
        <div className="mx-4 mt-6 mb-10 ">
            ...
            <Carousel className="mt-4 ">
                <CarouselContent>
                    <CarouselItem>
                        <div className="rounded-3xl bg-fondCard bg-opacity-60 p-4">
                    ...
                    <CarouselItem>
                        <div className="rounded-3xl  bg-fondCard bg-opacity-60 px-6">
                            <h2 className="font-semibold text-center py-2 flex justify-center">Yoga pour se ressourcer <Image src={EmojiDanse}/></h2>
                            <Image 
                            src={Brunch}
                            className="place-self-center"
                            />
                            <p className="text-center my-4 mb-6">
                                Recharge tes batteries avec notre brunch, placé entre les cours de Zumba et de Yoga ! Profite d’une pause gourmande et équilibrée pour savourer des plats délicieux, partager un moment convivial et préparer votre corps à une journée de détente totale. Un dimanche sous le signe du plaisir et de la vitalité!
                            </p>
                        </div>
                    </CarouselItem>
                    ...
                    <CarouselItem>
                        <div className="rounded-3xl bg-fondCard bg-opacity-60 p-4">
                            ...
                            />
                            <p className="text-center my-4">
                                On termine par un moment de reconnexion avec notre cours de yoga ouvert à tous les niveaux ! Que tu sois débutant ou confirmé, profites de postures adaptées afin de relâcher les tensions, gagner en souplesse et retrouver ton énergie. Rejoins-nous pour un instant de calme et de revitalisation !
                            </p>
                            <p className="text-center my-2">de <span className="font-semibold">10h</span> à <span className="font-semibold">10h45</span></p>
                            <div className="flex justify-center">
